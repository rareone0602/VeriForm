...
def prove(p, num_samples, output_dir, prover_batch_size, negation_type, port, formalizer_class_name):
    ...
    for chain in tqdm(chains):
        pkl_path = f"data/regex_perturbed/formalized/{formalizer_class_name}/{int(p * 100 + 0.5)}/{chain.chain_id}.pkl"
        save_path = f"data/regex_perturbed/proved/{formalizer_class_name}/{int(p * 100 + 0.5)}/{chain.chain_id}.json"
